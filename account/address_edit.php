...
<main>
    ...
    <form action="." method="post">
        ...
        <input type="text" name="line1" 
               value="<?php echo htmlspecialchars($address->getLine1()); ?>">
        <?php echo $fields->getField('line1')->getHTML(); ?><br>
        
        <label>Line 2:</label>
        <input type="text" name="line2" 
               value="<?php echo htmlspecialchars($address->getLine2()); ?>">
        <?php echo $fields->getField('line2')->getHTML(); ?><br>
        
        <label>City:</label>
        <input type="text" name="city" 
               value="<?php echo htmlspecialchars($address->getCity()); ?>">
        <?php echo $fields->getField('city')->getHTML(); ?><br>
        
        <label>State:</label>
        <input type="text" name="state" 
               value="<?php echo htmlspecialchars($address->getState()); ?>">
        <?php echo $fields->getField('state')->getHTML(); ?><br>
        
        <label>Zip Code:</label>
        <input type="text" name="zip" 
               value="<?php echo htmlspecialchars($address->getZipCode()); ?>">
        <?php echo $fields->getField('zip')->getHTML(); ?><br>
        
        <label>Phone:</label>
        <input type="text" name="phone" 
               value="<?php echo htmlspecialchars($address->getPhone()); ?>">
