...
<main>
    ...
    <div id="formatting_directions">
        <h2>Comment bien formater la description</h2>
        <ul>
            <li>Utilisez deux retours pour commencer un nouveau paragraphe</li>
            <li>Utilisez un astérisque pour marquer les éléments dans une liste à puces.</li>
            <li>Utilisez un retour entre les éléments d'une liste à puces.</li>
            <li>Utilisez les balises HTML standards pour le gras et l'italique.</li>
        </ul>
    </div>
